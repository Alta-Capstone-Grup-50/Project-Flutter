...
class DetailDataDokter extends StatelessWidget {
          ...
          SizedBox(
            ...
            child: Padding(
              ...
              child: Scrollbar(
                ...
                child: showDetail(context, putDataDokter, indexOfPage),
              ),
            ),
          ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Input(
                      initialValue: putDataDokter[indexOfPage].sip ?? '-',
                  ...
                  Padding(
                    ...
                    child: Input(
                      initialValue:
                          putDataDokter[indexOfPage].namaDokter ?? '-',
                      borderRadius: const BorderRadius.all(Radius.zero),
                      keyboardType: TextInputType.none,
                      enabled: false,
                    ),
                  ...
                  Padding(
                    ...
                    child: Input(
                      initialValue:
                          putDataDokter[indexOfPage].nomorTelfon ?? '-',
                      borderRadius: const BorderRadius.all(Radius.zero),
                      keyboardType: TextInputType.none,
                      enabled: false,
                    ),
                  ...
                  Padding(
                    padding: const EdgeInsets.only(top: 12),
                    child: Input(
                      initialValue: putDataDokter[indexOfPage].poli ?? '-',
                      borderRadius: const BorderRadius.all(Radius.zero),
                      keyboardType: TextInputType.none,
                      enabled: false,
                    ),
                  ...
                  Padding(
                    padding: const EdgeInsets.only(top: 12),
                    child: Input(
                      initialValue: putDataDokter[indexOfPage].nomorStr ?? '-',
                      borderRadius: const BorderRadius.all(Radius.zero),
                      keyboardType: TextInputType.none,
                      enabled: false,
                    ),
